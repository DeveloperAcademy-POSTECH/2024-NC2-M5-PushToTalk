...
//        channelManager.requestJoinChannel(channelUUID: testChannelUUID,
//                                          descriptor: channelDescriptor)
//        try await channelManager.setTransmissionMode(.halfDuplex,
...
//        print("Left channel with UUID: \(testChannelUUID)")
//    }
//    
//    ///앱을 나가거나 장치를 재부팅했을 때 채널을 복원해주는 함수
//    func channelDescriptor(restoredChannelUUID channelUUID: UUID) -> PTChannelDescriptor {
//        return getCachedChannelDescriptor(testChannelUUID)
//    }
//    
//    //임시
...
//            try await channelManager.setServiceStatus(.connecting, channelUUID: testChannelUUID)
//        }
//    
//        func reportServiceIsConnected() async throws {
//            try await channelManager.setServiceStatus(.ready, channelUUID: testChannelUUID)
//        }
//    
//    ///🟢  채널에서 음성 전송을 시작하고 싶을 떄
//    func startTransmitting() {
//        channelManager.requestBeginTransmitting(channelUUID: testChannelUUID)
//    }
...
//    func stopTalking() {
//        // Stop talking logic
//        channelManager.stopTransmitting(channelUUID: testChannelUUID)
//    }
...
//        channelManager.setActiveRemoteParticipant(nil, channelUUID: testChannelUUID)
//    }
//
//    
//    
